...
my_module.hello_world(input("Введите ваше имя: "))  # Вызовите функцию hello_world из модуля my_module
...
print(hello_world(input("Введите ваше имя: ")))  # Функция hello_world должна вызываться без указания модуля
